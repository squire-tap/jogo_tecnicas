...
Inimigo::Inimigo(vector2D<float> pos, vector2D<float> vel, vector2D<float> dim, const string caminhoText, int id, Heroi *p) : Atirador(pos, vel, dim, caminhoText, 2), pHeroi(p)
{
}
Inimigo::~Inimigo()
{
